...
![NFM 模型结构](https://cdn.jsdelivr.net/gh/jc-LeeHub/Recommend-System-tf2.0@master/image/NFM.png)
...
│   ├── NFM          # NFM 模型搭建
├── train.py 
│   ├── main         # 将处理好的数据输入 NFM 模型进行训练，并评估结果
```
...
模型准确率： Accuracy: 0.7875

loss下降曲线：

<div align=center><img src="https://cdn.jsdelivr.net/gh/jc-LeeHub/Recommend-System-tf2.0@master/image/NFM_loss.png" width="50%;" style="float:center"/></div>
